...
'todo:
'- add alignment for fixed width
'- add manual kern for fixed width
'- add change colors
...
'~ dim as string fileName = "BarbedorT_white.bmp"
'~ f1.manualTrim(0, 2, 0, 0) 'for fixed width fwprint
'~ f1.load(fileName, 16, 16)
'~ f1.autoTrim()

'~ f1.printTextAk(0, 0, "WWMRTYUIOPasdfghjkl~!@#$%^&*() 1234567890", FHA_LEFT)
'~ f1.setProp(8, +2, FDM_ALPHA) 'minSpacing, offsetSpacing, drawMode
'~ f1.printTextAk(0, 32, "WWMRTYUIOPasdfghjkl~!@#$%^&*() 1234567890", FHA_LEFT)
'~ f1.setProp(8, -2, FDM_ALPHA) 'minSpacing, offsetSpacing, drawMode
'~ f1.printTextAk(0, 64, "Lang verhaal hierzo. Bla, bla, 123test!", FHA_LEFT)
'~ f1.printTextFw(0, 96, "Fixed width WWgg() 1234567890")
